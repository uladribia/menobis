...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
pub(crate) fn fit_partial_strength_binomial_full(
    strength_out: Vec<f64>,
    strength_in: Vec<f64>,
    known_src: Vec<u64>,
    known_tgt: Vec<u64>,
    ...
    let r = core_fit_partial_strength_binomial(
        &strength_out,
        &strength_in,
        &known_src,
        &known_tgt,
...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
pub(crate) fn fit_partial_strength_edges_binomial_full(
    strength_out: Vec<f64>,
    strength_in: Vec<f64>,
    known_src: Vec<u64>,
    known_tgt: Vec<u64>,
    ...
    let r = core_fit_partial_strength_edges_binomial(
        &strength_out,
        &strength_in,
        &known_src,
        &known_tgt,
...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
pub(crate) fn fit_partial_strength_degree_binomial_full(
    strength_out: Vec<f64>,
    strength_in: Vec<f64>,
    degree_out: Vec<f64>,
    degree_in: Vec<f64>,
    ...
    let r = core_fit_partial_strength_degree_binomial(
        &strength_out,
        &strength_in,
        &degree_out,
        &degree_in,
...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
pub(crate) fn fit_partial_strength_edges_w_full(
    strength_out: Vec<f64>,
    strength_in: Vec<f64>,
    known_src: Vec<u64>,
    known_tgt: Vec<u64>,
    ...
    let r = core_fit_partial_strength_edges_w(
        &strength_out,
        &strength_in,
        &known_src,
        &known_tgt,
