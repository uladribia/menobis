...
use menobis_core::generation::microcanonical::support::uniform_edges::sample_uniform_support;
use menobis_core::generation::output::SampledNetwork;
...
pub fn sample_positive_occupations<F: FixedETOccupancy>(
    family: &F,
    t: OccNum,
    e: usize,
    rng: &mut StdRng,
