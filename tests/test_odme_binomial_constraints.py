...
from odme.filtering import FilterResult
...
class TestStrengthBinomial:
    ...
    def test_weights_bounded_by_layers(self) -> None:
        ...
        _src, _tgt, wgt = _odme.sample_strength_binomial(
    ...
    def test_reproducible(self) -> None:
        ...
        x = np.array([0.5, 0.6])
        y = np.array([0.4, 0.5])
        a = _odme.sample_strength_binomial(x.tolist(), y.tolist(), 10, True, 42)
        b = _odme.sample_strength_binomial(x.tolist(), y.tolist(), 10, True, 42)
        assert a == b
...
class TestStrengthCostBinomial:
    ...
    def test_sample_weights_bounded(self) -> None:
        ...
        _src, _tgt, wgt = _odme.sample_strength_cost_binomial(
    ...
    def test_filter_partitions(self) -> None:
        ...
        cost_tgt = [1, 2, 0, 2, 0, 1]
        cost_val = [1.0, 2.0, 1.0, 1.5, 2.0, 1.5]
        upper, _lower, _expected, _occ = _odme.filter_strength_cost_binomial(
            x,
            y,
            0.5,
            cost_src,
...
class TestStrengthEdgesBinomial:
    ...
    def test_sample_weights_bounded(self) -> None:
        ...
        x = [0.5, 0.6, 0.4]
        y = [0.4, 0.5, 0.5]
        _src, _tgt, wgt = _odme.sample_strength_edges_binomial(x, y, 0.5, 5, True, 42)
        assert all(w <= 5 for w in wgt)
    ...
    def test_sample_reproducible(self) -> None:
        ...
        x = [0.5, 0.6]
        y = [0.4, 0.5]
        a = _odme.sample_strength_edges_binomial(x, y, 0.5, 10, True, 42)
        b = _odme.sample_strength_edges_binomial(x, y, 0.5, 10, True, 42)
        assert a == b
    ...
    def test_filter_partitions(self) -> None:
        ...
        x = [0.5, 0.6, 0.4]
        y = [0.4, 0.5, 0.5]
        upper, _lower, _expected, _occ = _odme.filter_strength_edges_binomial(
            x,
            y,
            0.5,
            5,
    ...
    def test_pvalues_in_range(self) -> None:
        ...
        x = [0.5, 0.6, 0.4]
        y = [0.4, 0.5, 0.5]
        upper, lower, _, _ = _odme.filter_strength_edges_binomial(
            x,
            y,
            0.5,
            5,
...
class TestStrengthDegreeBinomial:
    ...
    def test_sample_weights_bounded(self) -> None:
        ...
        z = [0.3, 0.4, 0.2]
        w = [0.25, 0.35, 0.3]
        _src, _tgt, wgt = _odme.sample_strength_degree_binomial(x, y, z, w, 5, True, 42)
    ...
    def test_filter_partitions(self) -> None:
        ...
        z = [0.3, 0.4, 0.2]
        w = [0.25, 0.35, 0.3]
        upper, _lower, _expected, _occ = _odme.filter_strength_degree_binomial(
            x,
            y,
            z,
            w,
...
class TestDegreeEventsBinomial:
    ...
    def test_sample_weights_bounded(self) -> None:
        ...
        x = [0.5, 0.6, 0.4]
        y = [0.4, 0.5, 0.5]
        _src, _tgt, wgt = _odme.sample_degree_events_binomial(x, y, 0.5, 5, True, 42)
        assert all(w <= 5 for w in wgt)
    ...
    def test_filter_partitions(self) -> None:
        ...
        x = [0.5, 0.6, 0.4]
        y = [0.4, 0.5, 0.5]
        upper, _lower, _expected, _occ = _odme.filter_degree_events_binomial(
            x,
            y,
            0.5,
            5,
