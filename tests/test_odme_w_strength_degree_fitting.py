...
from odme.models import StrengthDegreeFit
...
def test_fit_strength_degree_geometric_recovers_homogeneous_constraints() -> None:
    ...
    from odme.models import fit_strength_degree_geometric
...
def test_fit_strength_degree_negative_binomial_rejects_single_layer() -> None:
    ...
    from odme.models import fit_strength_degree_negative_binomial
