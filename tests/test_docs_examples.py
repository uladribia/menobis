...
def _dense_network(node_count: int, *, seed: int = SEED) -> SyntheticNetwork:
...
def test_getting_started_gc_strength_fit_and_sample(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
    ...
    assert diagnostics.exactness == "exact_independent"
...
def test_ensemble_statistics_workflow(network: SyntheticNetwork) -> None:
...
def test_spatial_cost_gc_workflow(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
...
def test_microcanonical_edges_events(network: SyntheticNetwork) -> None:
...
def test_microcanonical_degree_events(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
...
def test_microcanonical_fixed_strength(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
    ...
    diagnostics = result.diagnostics
    assert diagnostics is not None
    assert diagnostics.exactness == "exact_stationary_mcmc"


def test_microcanonical_strength_edges(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
...
def test_microcanonical_strength_degree(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
...
def test_microcanonical_strength_cost(
    network: SyntheticNetwork, constraints: SyntheticConstraints
) -> None:
