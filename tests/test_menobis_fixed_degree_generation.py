...
def test_fixed_degree_events_me_sample_is_reproducible() -> None:
    ...
    fit = fit_degree_events_poisson(k_out, k_in, total_events=100)
    first = sample_degree_events_poisson(fit, seed=42)
    second = sample_degree_events_poisson(fit, seed=42)
