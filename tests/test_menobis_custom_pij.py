...
def test_custom_pij_events_multinomial_preserves_total_and_support() -> None:
    ...
    sample = sample_custom_multinomial(probabilities, total_events=100, seed=42)
...
def test_custom_pij_events_poisson_is_reproducible() -> None:
    ...
    first = sample_custom_poisson(probabilities, total_events=100, seed=42)
    second = sample_custom_poisson(probabilities, total_events=100, seed=42)
